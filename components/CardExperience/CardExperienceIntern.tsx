...
const CardExperienceIntern = (props: Props) => {
  return (
    <article className="flex flex-col rounded-lg items-center space-y-7 flex-shrink-0 w-[500px] md:w-[600px] xl:w-[900px] snap-center bg-[#292929] p-10 hover:opacity-100 opacity-40 cursor-pointer transition-opacity duration-200 overflow-hidden ">
      ...
      <div className="px-0 md:px-10">
        ...
        <div className="flex space-x-2 my-2">
          ...
          <img
            className="h-10 w-10 rounded-full object-cover"
            src="https://ik.imagekit.io/osw9g36vxc/logo-react-icon_d3Br7iaUz.png?ik-sdk-version=javascript-1.4.3&updatedAt=1665209529255"
            alt=""
          />
          <img
        ...
        <ul className="list-disc space-y-4 ml-5 text-lg">
          <li>
            Maintaining, optimizing, troubleshooting, and improving front-end
            website.
          </li>
          <li>
            Partnered with a designer teams to take client wireframes from
            concept to implementation.
          </li>
          <li>
            Pair programmed with a back-end developers, and reviewed team&apos;s
            code to catch previously missed error.
          </li>
        </ul>
      </div>
    </article>
...
export default CardExperienceIntern;
