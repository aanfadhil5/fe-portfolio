...
// Memoized proficiency level component
const ProficiencyLevel = React.memo(({ level }: { level: number }) => {
...
ProficiencyLevel.displayName = 'ProficiencyLevel'
...
function Skills({}: Props) {
  // Memoize skills grouped by category to avoid recalculation on every render
