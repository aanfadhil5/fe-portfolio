      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            {/* Menu Panel */}
            <motion.div
              className='absolute top-0 right-0 h-full w-80 max-w-[85vw] bg-white dark:bg-gray-900 shadow-xl'
              initial={{ x: '100%' }}
              animate={{ x: 0 }}
              exit={{ x: '100%' }}
                ...
                <nav className='flex flex-col space-y-4 mb-8'>
                  {navItems.map((item, index) => (
                    <motion.button
                      ...
                      className='text-left text-lg font-medium text-gray-900 dark:text-white hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-200 py-2'
      ...
      <div className='nav-container'>
        ...
        <div className='hidden md:flex items-center space-x-4'>
          ...
          <div className='flex items-center space-x-1'>
            {socialLinks.map((social, index) => (
              <SocialIcon key={social.href} social={social} index={index} />
            ))}
          </div>
