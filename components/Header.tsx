...
export default function Header({ darkMode, toggleDarkMode }: Props) {
  ...
  const socialLinks = [
    ...
    { href: "mailto:farhanfadhilah5@gmail.com", label: "Email" },
    { href: "https://wa.me/6281287673220", label: "WhatsApp" },
  ];
  ...
  return (
    <header className="nav">
      ...
      <AnimatePresence>
        {isMenuOpen && (
          <motion.div
            className="md:hidden absolute top-full left-0 right-0 bg-notion-bg dark:bg-dark-bg border-b border-notion-border-light dark:border-dark-border-light shadow-notion-card"
            initial={{ opacity: 0, y: -20 }}
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: -20 }}
          ...
          >
            <div className="px-4 py-6 space-y-4">
              ...
              <nav className="space-y-2">
                {navItems.map((item, index) => (
                  ...
                  >
                    <Link
                      href={item.href}
                      className="block px-3 py-2 nav-link text-base"
              ...
              {/* Mobile Actions */}
              <div className="pt-4 border-t border-notion-border-light dark:border-dark-border-light">
                {/* Mobile Social Links */}
